      ...
      <div class="mx-auto max-w-7xl px-2 sm:px-6 lg:px-8">
        <div class="relative flex items-center justify-between h-16">
          ...
          <div class="flex-shrink-0">
            <router-link to="/">
              <img class="h-36 w-auto" src="../assets/logo-roninmez.svg" alt="RONINMEZ - Soluciones digitales en desarrollo web y análisis de datos, posicionamiento SEO" />
            </router-link>
          </div>

          <!-- Centered welcome text (hidden on small screens) -->
          <div class="hidden sm:flex flex-grow justify-center">
            <p class="text-lg font-medium">Bienvenido Yadir Acuña</p>
          </div>
